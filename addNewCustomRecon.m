function [vUI, vEvent] = addNewCustomRecon(scan, vResource, vbuf_rx, vPData, vSeq, kwargs)
arguments
    scan Scan
...
% Process
nm = "newImagingProc"; % function name
...
vUI = VSXUI( ...
    ...
    'Callback', cellstr(["do"+nm+"(varargin)", "global TOGGLE_"+nm+"newImagingProc; TOGGLE_"+nm+" = logical(UIState); return;"]) ...
    );
