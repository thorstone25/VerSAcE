...
scn = ScanCartesian('x', 70e-3 * [-1 1]./2, 'z', [0, 100e-3]);
...
[us, chd] = UltrasoundSystem.Verasonics(Trans, TX, TW, 'c0', c0, 'Receive', Receive, 'RcvData', RcvData); % import to QUPS                                [us, chd] = UltrasoundSystem.Verasonics(Trans, TX, TW, 'Receive', Receive, 'RcvData', RcvData); % import to QUPS
