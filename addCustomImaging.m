...
% UI
vUI = VSXUI( ...
    'Control', {'UserB2','Style','VsToggleButton','Label', 'RealTime Imaging', 'Callback', str2func("do"+nm)}, ...
    'Statement', cellstr(["global TOGGLE_"+nm+"; TOGGLE_"+nm+" = false; return;"]), ... init
    'Callback', cellstr(["do"+nm+"(varargin)", "global TOGGLE_"+nm+"imagingProc; TOGGLE_"+nm+" = logical(UIState); return;"]) ...
    );
